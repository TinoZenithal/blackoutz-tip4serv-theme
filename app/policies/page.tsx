...
export default function PoliciesPage() {
  return <main className="policy-page">
    ...
    <article>
      ...
      <section><span>04</span><div><h2>NO CHANGE-OF-MIND REFUNDS</h2><p>BLACKOUTZ does not provide refunds because a customer changes their mind, makes an accidental purchase, does not use or claim a digital reward, or no longer wants a subscription or supporter purchase after payment. Please verify the product, player details, billing type and price before completing checkout.</p><p>This policy does not exclude any refund, replacement or other remedy that must be provided under applicable consumer law. Duplicate charges, non-delivery and purchases materially different from their description are assessed individually through BLACKOUTZ Discord support under applicable law and the payment provider&apos;s rules. Cancelling a subscription stops future renewals but does not refund earlier charges unless a refund is legally required.</p></div></section>
