...
export default function PoliciesPage() {
  return <main className="policy-page">
    ...
    <article>
      ...
      <section><span>06</span><div><h2>PRIVACY</h2><p>This storefront starts a Tip4Serv checkout without collecting your Discord, player or payment details. Tip4Serv requests and processes those details on its own secure checkout. Your display-currency choice is stored on your device. Basic security logs may be processed by the hosting provider. Tip4Serv and its payment providers process checkout information under their own policies.</p><p><a href="https://tip4serv.com/privacy-policy" target="_blank" rel="noreferrer">TIP4SERV PRIVACY POLICY →</a> <a href="https://tip4serv.com/terms-of-use" target="_blank" rel="noreferrer">TIP4SERV TERMS OF USE →</a></p></div></section>
